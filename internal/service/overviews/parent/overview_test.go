...
func TestWorkspaceContext(t *testing.T) {
	...
	result, err := ParentOverview(ScanSettings{Depth: 1})()(current, false)
	if err != nil {
...
func TestWorkspaceContextSkipsParentScanAtDepthZero(t *testing.T) {
	...
	result, err := ParentOverview(ScanSettings{Depth: 0})()(current, false)
	if err != nil {
		t.Fatalf("ParentOverview() error: %v", err)
	}
...
func TestWorkspaceContextUnreadableParent(t *testing.T) {
	...
	_, err := ParentOverview(ScanSettings{Depth: 1})()(current, false)
	if err == nil {
